...
task.tekton.dev/debug created
task.tekton.dev/openshift-cli created
task.tekton.dev/s2i-nodejs-v0-11-3-fixed created
task.tekton.dev/dummy-task created
task.tekton.dev/cd1-deployment created
task.tekton.dev/cd2-deploy created
task.tekton.dev/cd2-canary created
task.tekton.dev/cd2-verification created
condition.tekton.dev/is-equal unchanged
pipeline.tekton.dev/p2-nodejs-build-deploy created
triggertemplate.triggers.tekton.dev/t2-nodejs-build-deploy-trigger-template created
triggerbinding.triggers.tekton.dev/t2-nodejs-build-deploy-trigger-binding created
eventlistener.triggers.tekton.dev/t2-nodejs-build-deploy-trigger-listener created
