...
$ oc apply -f pipelines/01_tasks.yaml
$ oc apply -f pipelines/01_pipeline.yaml
...
tekton-101                                tekton-101-tekton-101.apps.cluster-56ea.sandbox779.opentlc.com                                       tekton-101                                5050-tcp                      None
